...
public class Board extends JPanel implements GameConstants {
	...
	private Timer timer ;
	GameSprite bg = new GameSprite("finalfloor.png");
	Image bgImage ;
	private int imageX, imageY, imageW=GameConstants.GWIDTH,imageH=200;
	public Board(){
...
public void drawBird(Graphics2D g){
	...
	public void drawBackGround(Graphics2D g){
		System.out.println("BG X "+imageX+" "+imageY+" "+imageW+" "+imageH);
		g.drawImage(bg.getCamera(imageX, imageY, imageW, imageH),0,0,GWIDTH,GHEIGHT,null);
